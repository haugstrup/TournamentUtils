...
// Prep list of counts
$arena_counts = ['Pinbot' => 1, 'Paragon' => 4, 'Embryon' => 4, 'Rollergames' => 1];

// Prep list of available arenas
$available_arenas = [new Arena('Pinbot'), new Arena('Rollergames'), new Arena('Paragon'), new Arena('Embryon'), new Arena('Scorpion'), new Arena('Black Pyramid')];
...
// Prep list of available arenas
$available_arenas = [new Arena('Pinbot'), new Arena('Rollergames'), new Arena('Paragon'), new Arena('Embryon')];
